...
<div id="ai-chat-component" class="panel aia-bg-dark aia-text-white py-4">
    ...
    <div class="container">
        <div class="settings">
            ...
            <div class="options">
                <div class="minimize" onclick="minimizeWindow()">
                ...
                <div class="resize" onclick="resizeWindow()">
        ...
        <div class="prompt-wrapper">
            <textarea form="chat-form" class="form-control" name="prompt" id="prompt" rows="4" placeholder="Me: "></textarea>
...
<div id="ai-assistant-icon" onclick="minimizeWindow()">
...
<script>
    ...
    function resizeWindow() {
        const options = document.querySelector('.options > .resize')
        if (document.querySelector('.panel').style.height !== '100vh') {
    ...
    function minimizeWindow() {
        const options = document.querySelector('.options > .minimize')
        if (document.querySelector('.panel').style.display === 'none') {
            // show the panel
            document.querySelector('.panel').style.display = 'block';
            // hide the chat icon
            document.getElementById('ai-assistant-icon').style.display = 'none'
            // resize the panel
            document.querySelector('.panel').style.width = '100%'
            document.querySelector('.panel').style.height = 'fit-content'
            document.querySelector('.panel').style.margin = '0'
            ...
            // show the icon
            document.getElementById('ai-assistant-icon').style.display = 'flex'
